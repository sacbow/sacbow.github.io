---
title: "Graph-based Probabilistic Programming"
excerpt: "An overview on message passing algorithms and their software abstractions in graph-based probabilistic programming."
date: 2025-12-05
collection: posts
...
For this reason, general-purpose PPLs such as Edward, TensorFlow Probability, Pyro, NumPyro, and Turing provide multiple inference backends—typically including MCMC, variational methods (although in practice users tend to rely on NUTS for many applications.)
